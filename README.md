...
This repository contains multiple small PHP projects and programs developed for learning and practice purposes.  
Each folder represents a different project demonstrating PHP concepts like form handling, session management, login systems, and more.
...
- Covers basic and intermediate PHP concepts  
- Includes form handling, session management, and validation examples  
- Organized folder-wise for better readability  
...
2. Move this repository folder into the `htdocs` directory  
3. Start **Apache** from the control panel  
4. Open your browser and type: http://localhost/<your-folder-name>/
